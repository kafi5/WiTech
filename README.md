...
**WiTech v2.0** — WPS Security Auditing Tool for Android / Termux

[![Version](https://img.shields.io/badge/version-2.0-brightgreen)](https://github.com/msrofficial/WiTech/releases)
[![Platform](https://img.shields.io/badge/platform-Android%20%2F%20Termux-blue)](https://termux.dev)
[![License](https://img.shields.io/badge/license-MIT-lightgrey)](LICENSE)
[![Visitors](https://visitor-badge.laobi.icu/badge?page_id=msrofficial.WiTech)](https://github.com/msrofficial/WiTech)
...
WiTech is a WPS (Wi-Fi Protected Setup) security auditing tool built for Android devices running Termux. It automates Pixie Dust and Bruteforce attacks against WPS-enabled routers, allowing security researchers and network administrators to evaluate the strength of their own wireless infrastructure.

WiTech v2.0 is a complete rewrite of the original v1 engine, introducing a global command system, session management, reporting, improved stability, and a built-in interactive help guide — all optimized for Android / Termux.
...
WiTech v2.0 installs globally. Once set up, you can run it from any directory using the `WiTech` command.
...
| Command | Description |
|---|---|
| `WiTech` | Run WiTech with default settings (wlan0 + Pixie Dust) |
| `WiTech menu` | Open WiTech interactive menu without auto-attack |
| `WiTech old` | Run the legacy engine (w1.py) with wlan0 |
| `WiTech update` | Pull latest updates from GitHub |
| `WiTech help` | Open the built-in interactive help guide |
| `WiTech fix` | Fix root / superuser issues |
| `WiTech contact` | Contact the developer |
...
```bash
WiTech -i wlan0 -b <BSSID> -K
```

**Bruteforce on a specific router:**
```bash
WiTech -i wlan0 -b <BSSID> -B
```

**Pixie Dust without touching Android WiFi settings:**
```bash
WiTech -i wlan0 -K --dts
```

**Resume a previous session:**
```bash
WiTech --list-sessions
WiTech -i wlan0 --resume-session <BSSID>
```

**Generate an HTML report:**
```bash
WiTech -i wlan0 -b <BSSID> -K --html-report
```

For the full argument reference, run `WiTech help` and select option 5.
...
WiTech is provided for educational and authorized penetration testing purposes only. You are solely responsible for ensuring you have permission to test any network. The author is not liable for any misuse, damage, or legal consequences resulting from the use of this tool.
...
<div align="center">
If WiTech has been useful, consider leaving a star on GitHub.<br>
