...
{LINE}
  ...
  {G}1{RS}  →  {W}What is witech? Introduction{RS}
  ...
  {G}9{RS}  →  {W}Available witech commands (quick reference){RS}
...
def section_intro():
    ...
    print(f'''
{LINE}
{Y}  1. What is witech — Introduction{RS}
{LINE}

{INFO} {W}witech{RS} is a WPS (Wi-Fi Protected Setup)
...
{LINE2}
  ...
  easily extracted — that's what witech tests.

{LINE2}
{Y}  What can witech do?{RS}
{LINE2}
...
{LINE2}
{Y}  Step 3 — Run witech{RS}
{LINE2}

{CMD} {C}cd /path/to/witech/folder{RS}
...
{LINE2}
{Y}  Use it in witech like this:{RS}
{LINE2}
...
{Y}  ─── Quick Launch ───{RS}\n  {G}witech{RS}              Run with default settings (wlan0 + Pixie Dust)\n  {G}witech menu{RS}         Open witech interactive menu (no auto-attack)\n  {G}witech old{RS}          Run old engine (w1.py) with wlan0\n  {G}witech update{RS}       Update witech to latest version\n  {G}witech help{RS}         Show this help guide\n  {G}witech fix{RS}          Fix root/superuser issues\n  {G}witech contact{RS}      Contact the developer (kafi)\n\n{Y}  ─── Android / Termux ───{RS}
...
{LINE2}
  ...
  {W}RHK TECH{RS}
  GitHub  : {C}rhktech{RS}
  telegram : {C}t.me/rhktech1m{RS}

{TIP} {M}Stay With RHK TECH — Stay safe, stay ethical.{RS}
''')
    pause()

# ────────────────────────────────────────────
def section_witech_commands():
    clear()
    banner()
    print(f'''
{LINE}
{Y}  9. Available witech Commands — Quick Reference{RS}
{LINE}
...
{LINE2}
  ...
  {G}witech{RS}
  ↳ Run witech with default settings
     (interface: wlan0, attack: Pixie Dust)

  {G}witech menu{RS}
  ↳ Open witech interactive menu without auto-attack
     (runs: sudo python main.py)

  {G}witech old{RS}
  ↳ Run the old witech engine (w1.py)
...
{LINE2}
  ...
  {G}witech contact{RS}
  ↳ Contact the developer (rhktech)

{LINE2}
{G}  ─── With Arguments (Advanced) ───{RS}
{LINE2}

  {G}witech -i wlan0 -b AA:BB:CC:DD:EE:FF -K{RS}
  ↳ Pixie Dust on a specific router

  {G}witech -i wlan0 -b AA:BB:CC:DD:EE:FF -B{RS}
  ↳ Bruteforce on a specific router

  {G}witech -i wlan0 -K --dts{RS}
...
def main():
    ...
    while True:
        ...
        if choice == '0':
            clear()
            print(f'\n{M}  ★ Stay With RHK Tech — Thanks for using WiTech!{RS}\n')
            sys.exit(0)
