...
echo -e "${C_B_GRN}▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰${R}"
echo -e "${B}${C_B_YLW}  PROTOCOL COMPLETE. MAINTAINER: RHK Tech${R}"
echo -e "${C_D_GRN}  [*] GitHub       : ${C_B_GRN}msrofficial${R}"
echo -e "${C_D_GRN}  [*] Telegram     : ${C_B_GRN}@rhktech${R}"
echo -e "${C_D_GRN}  [*] TG Group     : ${C_B_GRN}@rhktech1m${R}"
echo -e "${C_D_GRN}  [*] Google Search: ${C_B_GRN}RHK Tech${R}"
echo -e "${C_B_GRN}▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰${R}"
